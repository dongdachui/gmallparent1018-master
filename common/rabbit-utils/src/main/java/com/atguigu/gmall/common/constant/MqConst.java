...
public class MqConst {
     ...
     * 秒杀减库存
     */
    public static final String EXCHANGE_DIRECT_ACTIVITY_STOCK = "exchange.direct.activity.stock";
    public static final String ROUTING_ACTIVITY_STOCK = "activity.stock";
    //队列
    public static final String QUEUE_ACTIVITY_STOCK  = "queue.activity.stock";
